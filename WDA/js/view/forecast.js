function initForecasts(place_id,today) {
	console.log("initForecasts "+place_id+" "+today)
...
function showWaterContentForecast(place_id, place, name, forecast, binding) {
	...
	$("#forecast_" + place_id + "_" + forecast)
			.append(
					"<div class='row flex-row-reverse align-items-center mt-3'>"
							...
							+ "\" />"
							+ "<input class='form-control form-control-sm' type='hidden' name='title' value='"
							+ escape(name + " - Water content forecast")
							+ "' />"
							+ "<button class='btn btn-primary ml-3' type='submit'><small><i class='fas fa-external-link-alt'></i>&nbsp;History</small></button></form>"
							+ "<button type='button'class='btn btn-info ml-3'>"
							+ "<span class='badge badge-light'>"
							...
							+ "</span>"
							+ "</button>"
							+ "<span class='font-weight-bold'>Water content (mm)</span></div>");
}

function showDeficitForecast(place_id, place, name, forecast, binding) {
	...
	$("#forecast_" + place_id + "_" + forecast)
			.append(
					"<div class='row flex-row-reverse align-items-center mt-3'>"
							...
							+ "</span>"
							+ "</button>"
							+ "<span class='font-weight-bold'>Deficit (mm)</span></div>");
}

function showThresholdForecast(place_id, place, name, forecast, binding) {
	...
	$("#forecast_" + place_id + "_" + forecast)
			.append(
					"<div class='row flex-row-reverse align-items-center mt-3'>"
							...
							+ "\" />"
							+ "<input class='form-control form-control-sm' type='hidden' name='title' value='"
							+ escape(name + " - Threshold forecast")
							+ "' />"
							+ "<button class='btn btn-primary ml-3' type='submit'><small><i class='fas fa-external-link-alt'></i>&nbsp;History</small></button></form>"
							+ "<button type='button'class='btn btn-info ml-3'>"
							+ "<span class='badge badge-light'>"
							...
							+ "</span>"
							+ "</button>"
							+ "<span class='font-weight-bold'>Threshold (mm)</span></div>");
}